...
c ******************** YUMING 2020-2-2 *********************************
      REAL TT,TTp ! Tidal level
      REAL SAL1,SAL2 ! Monitored salinity
      REAL AMP ! Tidal amplitude
      INTEGER NSAL,PERIOD
C                                                                        BCTIME........2600
...
C.....NSOUI IS ACTUAL NUMBER OF ENERGY OR SOLUTE MASS SOURCE NODES       BCTIME.......10400
      ...
      AMP=0.06
      PERIOD=90  ! second
      TT=0.47+AMP*SIN(2*3.1415926*TSEC/PERIOD)
      WRITE(*,*) 'it=',it,'tide=',tt
C                                                                        BCTIME.......10600
C                                                                        BCTIME.......10700
C                                                                        BCTIME.......10800
...
C     UBC(IP) =  ((          ))                                          BCTIME.......12700
      IF(IABS(I).GE.1) THEN
        PBC(IP)=9.8*(1000+SAL1*714.3)*(TT-Y(IABS(I)))
        UBC(IP)=SAL1
      ENDIF
...
C     DATA FOR REGION 1:                                                 UNSAT.........3800
      DATA   SWRES1/0.1E0/,   AA1/1.9E-4/,   VN1/2.68E0/                 UNSAT.........3900
      SAVE SWRES1, AA1, VN1                                              UNSAT.........4000
C     DATA FOR REGION 2:                                                 UNSAT.........4100
      DATA   SWRES2/0.001E0/,   AA2/4.5E-3/,   VN2/10E0/                 UNSAT.........4200
